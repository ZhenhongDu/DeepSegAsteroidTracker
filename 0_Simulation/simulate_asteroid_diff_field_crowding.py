...
ASTEROID_NUM = 360
asteroid_intensity = 60 # intensity, related to SNR

save_path = '/data/Data_zhenhong/asteroid/simulation_results/diff_field_crowding_2/'

save_name = 'simulate_data_star_NUM_{}.tif'.format(ASTEROID_NUM)
gt_name = 'gt_data_star_NUM_{}.tif'.format(ASTEROID_NUM)
...
# star parameter
large_star_num = 3
middle_star_num = ASTEROID_NUM - 10
small_star_num = 7
